				...
				<table id="daftar-kecamatan" class="table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td class="hidden-480">
								<span class="label label-primary">
									{{ Kecamatan::find($temp->id)->Tps()->count() }} TPS
								</span>
							</td>
							<td class="td-actions">
								...
								<div class="hidden-desktop visible-phone">
									<div class="inline position-relative">
										...
										<ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
											<li>
												<a data-toggle="modal" onclick="modalLihatKecamatan({{$temp->id}})" class="tooltip-info" data-rel="tooltip" title="Lihat">
													<span class="blue">
											...
											<li>
												<a data-toggle="modal" onclick="modalUbahKecamatan({{$temp->id}})" class="tooltip-success" data-rel="tooltip" title="Ubah">
													<span class="green">
											...
											<li>
												<a data-toggle="modal" onclick="modalHapusKecamatan({{$temp->id}})" class="tooltip-error" data-rel="tooltip" title="Hapus">
													<span class="red">

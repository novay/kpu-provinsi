...
<div class="modal-body overflow-visible">
	{{ Form::open(array('route' => 'ganti_avatar', 'files' => true, 'class' => 'form-horizontal form-ubah-avatar')) }}
	<div class="control-group" id="control-avatar">
		...
		<div class="widget-main">
			<div class="ace-file-input">
				...
				<small><span class="help-block text-center" id="error-avatar">lkjlk</span></small>
			</div>
		</div>
	</div>
